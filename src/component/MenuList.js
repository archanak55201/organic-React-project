...
const MenuList=({value,closemenu})=> {
  ...
  return (
    <div style={{display:`${value}`}} className='menu' >
          ...
          <div className='menu-name'><NavLink to={'/ourStory'} onClick={()=>{closemenu()}}>Story</NavLink></div>

          <div className='menu-name'><NavLink to={'/founder'} onClick={()=>{closemenu()}}> Our Founders</NavLink></div>
